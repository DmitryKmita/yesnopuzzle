...
var getCommentsLength = function(id) {
  var records = [];
...
questions.push({
  ...
  "author": 1,
  "commentsCount": getCommentsLength(1),
  "createdOn": new Date()
});
...
questions.push({
  ...
  "author": 1,
  "commentsCount": getCommentsLength(2),
  "createdOn": new Date()
});
...
questions.push({
  ...
  "author": 2,
  "commentsCount": getCommentsLength(3),
  "createdOn": new Date()
});
...
questions.push({
  ...
  "author": 2,
  "commentsCount": getCommentsLength(4),
  "createdOn": new Date()
});
...
questions.push({
  ...
  "author": 2,
  "commentsCount": getCommentsLength(5),
  "createdOn": new Date()
});
