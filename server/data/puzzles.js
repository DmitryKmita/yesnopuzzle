...
var getQuestionsLength = function(id) {
  var records = [];
  questions.forEach(function(question) {
    if (question.puzzle == id) {
      records.push(question.id);
    }
  });
...
puzzles.push({
  ...
  "author": 1,
  "questionsCount": getQuestionsLength(1),
  "createdOn": new Date()
});
...
puzzles.push({
  ...
  "author": 1,
  "questionsCount": getQuestionsLength(2),
  "createdOn": new Date()
});
...
puzzles.push({
  ...
  "author": 2,
  "questionsCount": getQuestionsLength(3),
  "createdOn": new Date()
});
...
puzzles.push({
  ...
  "author": 2,
  "questionsCount": getQuestionsLength(4),
  "createdOn": new Date()
});
...
puzzles.push({
  ...
  "author": 2,
  "questionsCount": getQuestionsLength(5),
  "createdOn": new Date()
});
